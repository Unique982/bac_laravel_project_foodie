...
<head>
    ...
    <title>Foodie @yield('Unique Neupane')</title>
    ...
    <!--
      - preload images
    -->
    <link rel="preload" as="image" href="{{asset('assets/frontend/images/hero-banner.png')}}" media="min-width(768px)">
    <link rel="preload" as="image" href="{{asset('assets/frontend/images/hero-banner-bg.png')}}" media="min-width(768px)">
    <link rel="preload" as="image" href="{{asset('assets/frontend/images/hero-bg.jpg')}}">
...
<main>
    <article>
        ...
        <section class="hero" id="home" style="background-image: url({{asset('assets/frontend/images/hero-bg.jpg')}})">
            <div class="container">
                ...
                <figure class="hero-banner">
                    <img src="{{asset('assets/frontend/images/hero-banner-bg.png')}}" width="820" height="716" alt="" aria-hidden="true"
                         class="w-100 hero-img-bg">

                    <img src="{{asset('assets/frontend/images/hero-banner.png')}}" width="700" height="637" loading="lazy" alt="Burger"
                ...
                <ul class="promo-list has-scrollbar">
                    ...
                    <li class="promo-item">
                        <div class="promo-card">
                            ...
                            <img src="{{asset('assets/frontend/images/promo-1.png')}}" width="300" height="300" loading="lazy" alt="Maxican Pizza"
                    ...
                    <li class="promo-item">
                        <div class="promo-card">
                            ...
                            <img src="{{asset('assets/frontend/images/promo-2.png')}}" width="300" height="300" loading="lazy" alt="Soft Drinks"
                                 class="w-100 card-banner">
                    ...
                    <li class="promo-item">
                        <div class="promo-card">
                            ...
                            <img src="{{asset('assets/frontend/images/promo-3.png')}}" width="300" height="300" loading="lazy" alt="French Fry"
                                 class="w-100 card-banner">
                    ...
                    <li class="promo-item">
                        <div class="promo-card">
                            ...
                            <img src="{{asset('assets/frontend/images/promo-4.png')}}" width="300" height="300" loading="lazy" alt="Burger Kingo"
                                 class="w-100 card-banner">
                    ...
                    <li class="promo-item">
                        <div class="promo-card">
                            ...
                            <img src="{{asset('assets/frontend/card-banner')}}">
        ...
        <section class="section section-divider gray about" id="about">
            <div class="container">
                ...
                <div class="about-banner">
                    <img src="{{asset('assets/frontend/images/about-banner.png')}}" width="509" height="459" loading="lazy" alt="Burger with Drinks"
                         class="w-100 about-img">

                    <img src="{{asset('assets/frontend/images/sale-shape-red.png')}}" width="216" height="226" alt="get up to 50% off now"
                ...
                <ul class="food-menu-list">
                    ...
                    <li>
                        <div class="food-menu-card">
                            ...
                            <div class="card-banner">
                                <img src="{{asset('assets/frontend/images/food-menu-2.png')}}" width="300" height="300" loading="lazy"
                    ...
                    <li>
                        <div class="food-menu-card">
                            ...
                            <div class="card-banner">
                                <img src="{{asset('assets/frontend/images/food-menu-3.png')}}" width="300" height="300" loading="lazy"
                    ...
                    <li>
                        <div class="food-menu-card">
                            ...
                            <div class="card-banner">
                                <img src="{{asset('assets/frontend/images/food-menu-4.png')}}" width="300" height="300" loading="lazy"
                    ...
                    <li>
                        <div class="food-menu-card">
                            ...
                            <div class="card-banner">
                                <img src="{{asset('assets/frontend/images/food-menu-5.png')}}" width="300" height="300" loading="lazy"
                    ...
                    <li>
                        <div class="food-menu-card">
                            ...
                            <div class="card-banner">
                                <img src="{{asset('assets/frontend/images/food-menu-6.png')}}" width="300" height="300" loading="lazy"
        ...
        <section class="section section-divider white cta" style="background-image: url('./assets/images/hero-bg.jpg')">
            <div class="container">
                ...
                <figure class="cta-banner">
                    <img src="{{asset('assets/frontend/images/cta-banner.png')}}" width="700" height="637" loading="lazy" alt="Burger"
                         class="w-100 cta-img">

                    <img src="{{asset('assets/frontend/images/sale-shape.png')}}" width="216" height="226" loading="lazy"
        ...
        <section class="section section-divider gray delivery">
            <div class="container">
                ...
                <figure class="delivery-banner">
                    <img src="{{asset('assets/frontend/images/delivery-banner-bg.png')}}" width="700" height="602" loading="lazy" alt="clouds"
                         class="w-100">

                    <img src="{{asset('assets/frontend/images/delivery-boy.svg')}}" width="1000" height="880" loading="lazy" alt="delivery boy"
                    ...
                    <li class="testi-item">
                        <div class="testi-card">
                            ...
                            <div class="profile-wrapper">
                                ...
                                <figure class="avatar">
                                    <img src="{{asset('assets/frontend/images/avatar-1.jpg')}}" width="80" height="80" loading="lazy" alt="Robert William">
                                </figure>
                    ...
                    <li class="testi-item">
                        <div class="testi-card">
                            ...
                            <div class="profile-wrapper">
                                ...
                                <figure class="avatar">
                                    <img src="{{asset('assets/frontend/images/avatar-2.jpg')}}" width="80" height="80" loading="lazy" alt="Thomas Josef">
                                </figure>
                    ...
                    <li class="testi-item">
                        <div class="testi-card">
                            ...
                            <div class="profile-wrapper">
                                ...
                                <figure class="avatar">
                                    <img src="{{asset('assets/frontend/images/avatar-3.jpg')}}" width="80" height="80" loading="lazy" alt="Charles Richard">
                                </figure>
                ...
                <ul class="banner-list">
                    ...
                    <li class="banner-item banner-lg">
                        <div class="banner-card">
                            ...
                            <img src="{{asset('assets/frontend//images/banner-1.jpg')}}" width="550" height="450" loading="lazy"
                    ...
                    <li class="banner-item banner-sm">
                        <div class="banner-card">
                            ...
                            <img src="{{asset('assets/frontend/images/banner-2.jpg')}}" width="550" height="465" loading="lazy" alt="Delicious Pizza"
                                 class="banner-img">
                    ...
                    <li class="banner-item banner-sm">
                        <div class="banner-card">
                            ...
                            <img src="{{asset('assets/frontend/images/banner-3.jpg')}}" width="550" height="465" loading="lazy" alt="American Burgers"
                                 class="banner-img">
                    ...
                    <li class="banner-item banner-md">
                        <div class="banner-card">
                            ...
                            <img src="{{asset('assets/frontend/images/banner-4.jpg')}}" width="550" height="220" loading="lazy" alt="Tasty Buzzed Pizza"
                                 class="banner-img">
                ...
                <ul class="blog-list">
                    ...
                    <li>
                        <div class="blog-card">
                            ...
                            <div class="card-banner">
                                <img src="{{asset('assets/frontend/images/blog-1.jpg')}}" width="600" height="390" loading="lazy"
                    ...
                    <li>
                        <div class="blog-card">
                            ...
                            <div class="card-banner">
                                <img src="{{asset('assets/frontend/images/blog-2.jpg')}}" width="600" height="390" loading="lazy"
                    ...
                    <li>
                        <div class="blog-card">
                            ...
                            <div class="card-banner">
                                <img src="{{asset('assets/frontend/images/blog-3.jpg')}}" width="600" height="390" loading="lazy"
...
<footer class="footer">
    ...
    <div class="footer-top" style="background-image: url('{{asset('assets/frontend/images/footer-illustration.png')}}')">
        <div class="container">
